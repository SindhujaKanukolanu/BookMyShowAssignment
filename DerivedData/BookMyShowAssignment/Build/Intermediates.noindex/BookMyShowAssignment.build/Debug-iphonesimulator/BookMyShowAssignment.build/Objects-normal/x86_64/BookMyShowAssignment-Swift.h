...
#ifndef BOOKMYSHOWASSIGNMENT_SWIFT_H
#define BOOKMYSHOWASSIGNMENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BookMyShowAssignment",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20BookMyShowAssignment11AppDelegate")
...
SWIFT_CLASS("_TtC20BookMyShowAssignment13SceneDelegate")
...
SWIFT_CLASS("_TtC20BookMyShowAssignment14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(BookMyShowAssignment)) <UISearchResultsUpdating>
